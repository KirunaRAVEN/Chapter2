...
public:
    ...
    *
    *  IN:          HardwareSerial instance (e.g., Serial by default)
    *  OUT:         Nothing
    */
    ...
    *
    *  IN:          Nothing
    *  OUT:         ControlBoxStateMessage struct with the state of the buttons and switches.
    */
    ControlBoxStateMessage getMessage() { return _message; }

private:
    HardwareSerial* _serial; // Reference to the HardwareSerial instance (e.g., Serial)
